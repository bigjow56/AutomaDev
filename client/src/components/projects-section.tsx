...
import { ExternalLink, Github, Eye, FileText, Image as ImageIcon } from "lucide-react";
          ...
          {projects.map((project, index) => {
            ...
            return (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="bg-slate-800/40 border-purple-500/20 backdrop-blur-sm hover:border-purple-500/40 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-purple-500/20 relative overflow-hidden group h-full flex flex-col">
                  ...
                  <CardContent className="p-6 relative z-10 flex flex-col h-full">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {tags.slice(0, 4).map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-2 py-1 bg-purple-600/20 text-purple-300 text-xs rounded-full border border-purple-600/30 font-medium"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="flex flex-col gap-3 mt-auto">
                      {/* Metric display */}
                      <div className="inline-flex items-center px-3 py-2 bg-purple-600/10 border border-purple-500/20 rounded-full text-purple-300 text-sm w-fit">
                      ...
                      <Button
                        ...
                        className="border-purple-500/30 text-purple-300 hover:bg-purple-600/20 hover:border-purple-500/50 transition-all w-full"
